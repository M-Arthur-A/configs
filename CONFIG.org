...
myKeys =
    ...
    -- KB_GROUP alt+TAB functionality
        , ("M4-<Tab>", spawn "rofi -show window -line-padding 4 -lines 6 -padding 50 -hide-scrollbar -show-icons -drun-icon-theme 'Arc-X-D' -font 'Droid Sans Regular 10'")
        , ("M4-S-<Tab>", nextMatch Backward (return True)) -- navigate aka alt+tab
