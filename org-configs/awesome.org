:PROPERTIES:
:ID:       baf7f3c3-14f1-4d50-9b29-9a58a1ad6d63
:END:
#+title: awesome
#+STARTUP: overview

* imports
#+BEGIN_SRC lua :tangle /home/arthur/.config/awesome/rc.lua
...
local editor      = "vim" -- os.getenv("EDITOR") or "vim"
...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " MAIN ", "DOC", " WWW ", " DEV ", " MES ", " SYS ", " ADD1 ", " ADD2 ", " ADD3 " }
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey,         }, "e", function () awful.spawn( explorer ) end,
              {description = "Launch explorer", group = "awesome"}),
    ...
    -- Run launcher
    awful.key({ modkey,         }, "space", function () awful.util.spawn("dmenu_run -fn 'Noto Sans:bold:pixelsize=24' -i -p \'Run: \'") end,
      ...
      grabber =
        awful.keygrabber.run(
          function(_, key, event)
            ...
            if     key == "a" then awful.spawn.with_shell("pamac-manager")
            elseif key == "s" then awful.spawn.with_shell("manjaro-settings-manager")
            elseif key == "c" then calc_dropdown:toggle()
            end
      ...
      grabber =
        awful.keygrabber.run(
          function(_, key, event)
            ...
            if     key == "e" then awful.spawn.with_shell(emacs .. "--eval '(dashboard-open)'")
            elseif key == "d" then awful.spawn.with_shell(emacs .. "--eval '(dired nil)'")
            elseif key == "c" then awful.spawn.with_shell(emacs .. "/home/arthur/CONFIG.org")
            elseif key == "n" then awful.spawn.with_shell(emacs .. "/home/arthur/Project/Notes/roam/20220507152159-notes.org")
            end
            awful.keygrabber.stop(grabber)
            end
          )
    ...
    awful.key({ modkey, }, "w", function () awful.screen.focused().quake:toggle() end,
              {description = "dropdown application", group = "super"}),
    awful.key({ modkey, ctrlkey }, "w", nil, function () terminal_dropdown:toggle() end,
              {description = "terminal dropdown", group = "super"}),
